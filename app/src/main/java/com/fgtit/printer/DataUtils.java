...
/**
 * class provides the utility methods for process the data.
 */
public class DataUtils {
    ...
    /**
     * method of checking two byte array are the same or not
     * @param d1 byte array 1
     * @param d2 byte array 2
    ...
    /**
     * Method of converting the byte[] into char[]
    ...
    /**
     * Method of generating the random length of byte array
     * @param nlength length of the byte array
     * @return byte[] with specific length
     */
    ...
    /**
     * method of reversing the black and white
     * related to image pixel
     * @param data byte[] need to change
     */
    ...
    /**
     * Method of getting the sub-byte of byte array
     * @param org original byte array
     * @param start starting point
     * @param length end point
